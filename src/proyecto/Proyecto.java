...
public class Proyecto {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; 1 < conductores.length; i++) {
            System.out.println(conductores[i].toString());
       ...
       String buscar;
        System.out.println("Ingrese nombre del conductor que desea");
        ...
        for (int i = 0; i < conductores.length; i++) {
           if(conductores[i].getNombre().equalsIgnoreCase(buscar)) {
               System.out.println("Conductor encontrado: ");
                  conductores[i].infoConductor();
               encontrado=true;
               
           }
        }
        if (!encontrado) System.out.println("Conductor no encontrado.");
